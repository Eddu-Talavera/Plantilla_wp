                        ...
                        <div class="dropdown d-inline-block ml-2">
                            <button type="button" class="btn header-item waves-effect"
                                ...
                                <img class="rounded-circle header-profile-user" src="assets/images/users/avatar-2.jpg"
                                    alt="Header Avatar">
                                <span class="d-none d-sm-inline-block ml-1">DD T.A.</span>
                                <i class="mdi mdi-chevron-down d-none d-sm-inline-block"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="index.html" class="waves-effect"><i class="mdi mdi-home-analytics"></i><span
                                        class="badge badge-pill badge-primary float-right">5</span><span>Inicio</span></a>
                            </li>

                            <li>
                                <a href="P_mujer.php" class="ui-buttons.html"><i
                                        class="mdi mdi-menu"></i><span>Mujer</span></a>
                            </li>

                            <li>
                                <a href="p_hombre.html" class="ui-buttons.html"><i
                                    class="mdi mdi-menu"></i><span>Hombres</span></a>
                            </li>

                            <li>
                                <a href="javascript: void(0);" class="ui-buttons.html"><i
                                    class="mdi mdi-menu"></i><span>Infantil</span></a>
                            </li>

                            <li>
                                <a href="javascript: void(0);" class="ui-buttons.html"><i
                                    class="mdi mdi-menu"></i><span>Mezcilla</span></a>
                            </li>
